        ...
        jo('div', { class: 'w-full flex justify-between  max-[1250px]:gap-y-[130px] gap-[5%] p-[5%] max-[1250px]:flex-col-reverse max-[1250px]:items-center max-[1250px]:justify-center  ', children: [
            // catalog
                ...
                jo('div', {class:'flex flex-col gap-[26px]  max-[1250px]:items-center max-[1250px]:justify-center', children:[
                    ...
                    jo('p', {class:'text-[#6A6A6A] text-sm max-[1250px]:w-[60%] max-[1250px]:text-center ',t:"Donec mattis porta eros, aliquet finibus risus interdum at. Nulla vivethe as it was for us to know what was to be done. the this is a long  post for the text.`This small text has to be place here, since this is a place holder. You can also chane it."}),
